...
public class Main {
    ...
    public static void main(String[] args){
        Car peugeot = new Car(Brand.PEUGEOT, Color.BLACK, 150, new BigDecimal(12000),10);
        ...
        Truck camion = new Truck(new BigDecimal(100000),Color.BLUE, 2000);
        System.out.println("El objeto camión: " + camion);
        camion.clean();
        System.out.println("Intento cargar una carga más alta de la soportada en el camión");
        try {
            camion.setCargaCamion(2500);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }


        Bicycle bicicleta = new Bicycle(new BigDecimal(1000), Color.BLACK,Brand.BMC);
        System.out.println("El objeto bicicleta: " + bicicleta);
        bicicleta.clean();
        bicicleta.startRiding();
